...
@app.post("/")  # Set this to POST to match Dialogflow's request
    ...
    if session_id not in inprogress_orders:
        ...
        if order_id == -1:
            ...
            fulfillment_text = f"Awesome. We have placed your order. " \
                               ...
                               f"and total amount ₹ {order_total} which you can pay at the time of delivery!"
